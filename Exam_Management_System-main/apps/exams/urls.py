...
admin_patterns = [
    ...
    path('papers/<int:pk>/publish/', views.paper_publish, name='paper_publish'),
    
    # Exam schedule
    path('schedules/', views.schedule_list, name='schedule_list'),
    path('schedules/create/', views.schedule_create, name='schedule_create'),
    path('schedules/debug/', views.exam_schedules_debug, name='schedules_debug'),
    
    # Exam grading
    path('submissions/', views.exam_submissions_list, name='submissions_list'),
    path('submissions/<int:schedule_id>/', views.exam_submissions_detail, name='submissions_detail'),
    path('submissions/<int:schedule_id>/student/<int:student_id>/grade/', views.grade_exam_submission, name='grade_submission'),
    
    # API endpoints
    path('api/subjects-by-department/', views.get_subjects_by_department, name='get_subjects_by_department'),
]

# Student URLs
student_patterns = [
    path('dashboard/', views.student_dashboard, name='dashboard'),
    path('subjects/', views.student_subject_list, name='subjects'),
