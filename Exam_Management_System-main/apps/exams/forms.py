...
from .models import Subject, Question, QuestionPaper, ExamSchedule, Department
...
class SubjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Subject
        fields = ['code', 'name', 'description', 'department', 'credits']
        widgets = {
...
class QuestionPaperForm(forms.ModelForm):
    ...
    selected_students = forms.ModelMultipleChoiceField(
        ...
        widget=forms.CheckboxSelectMultiple,
        required=False,
        label="Select Students to Publish"
    )
